 ...
 * CCTW Controller
 */
public class CCTWViewController implements SeekBar.OnSeekBarChangeListener,CompoundButton.OnCheckedChangeListener,DeviceStatusObserver.Observer{
    ...
    public CCTWViewController(View view, CCTWUtil mCctwUtil,Context context) {
...
//        this.mCctwUtil = new CCTWUtil(context,((MainActivity)context).getMeshService());
    ...
    public void setUiUpdateListener(OnUIUpdateListener uiUpdateListener){
...
//                        uiUpdateListener.onUpdate();
    ...
    public void refreshDeviceUI(){
        ...
        this.tv_color.setText(deviceOperationPO.getValue2()+"%");
    ...
    public void refreshGroupUI(){
        ...
        groupOperationPO = GroupOperationPO.getGroupOperationPO(relativeId);
        this.tv_color.setText(groupOperationPO.getValue2()+"%");
